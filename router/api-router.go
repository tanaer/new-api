...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.GET("/bepusdt/notify", controller.BepusdtNotify)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/futoon/pay", middleware.CriticalRateLimit(), controller.RequestFutoonPay)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/futoon/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestFutoonPay)
		...
		apiRouter.POST("/user/futoon/notify", controller.FutoonNotify)
		apiRouter.GET("/user/futoon/notify", controller.FutoonNotify)
		apiRouter.POST("/subscription/futoon/notify", controller.SubscriptionFutoonNotify)
		apiRouter.GET("/subscription/futoon/notify", controller.SubscriptionFutoonNotify)
		...
		supplierRoute.Use(middleware.RootAuth())
		{
			...
			supplierRoute.GET("/:id/groups", controller.GetSupplierGroups)
